...
class PDF extends FPDF
{
   ...
   function Header()
   {
    include"../Proyecto/Estructura/conexion.php";
       //llamamos a la conexion BD

      $consulta_info = $conexion->query(" select * from venta "); //traemos datos de la empresa desde BD
...
$consulta_reporte_asistencia = $conexion->query(" select * from venta ");
